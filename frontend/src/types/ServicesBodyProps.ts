...
export interface ServicesBodyProps {
    ...
    domain: string; // DNS of the service, used to identify the service
    ...
    user_role: "ADMINISTRATOR" | "DEVELOPER" | "USER"; // Role of the user in the service, e.g., "admin", "user", etc.
