...
export async function userHasRight(userID: string, serviceID: string, rightName: "MANAGE_TUNNELS" | "MANAGE_DEVS" | "VIEW_STATS" | "READ" | "WRITE" | "DELETE" | "MANAGE_USERS" | "MANAGE_ROLES" | "MANAGE_SERVICE" | "MANAGE_SETTINGS" | "VIEW_USERS" | "VIEW_ROLES" | "VIEW_SERVICE" | "VIEW_SETTINGS" | "DEV_TOKEN_CREATION" | "PROD_TOKEN_CREATION"): Promise<boolean> {
